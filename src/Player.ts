...
class Player extends EventEmitter<PlayerEvents> {
    ...
    private _handleVoiceState(oldState: VoiceState, newState: VoiceState): void {
        ...
        if (!oldState.channelId && newState.channelId && newState.member.id === newState.guild.members.me.id) {
            ...
            if (!oldState.channelId && newState.channelId && newState.member.id === newState.guild.id) {
            ...
            if (oldState.channelId === newState.channelId && oldState.member.id === newState.guild.id) {
